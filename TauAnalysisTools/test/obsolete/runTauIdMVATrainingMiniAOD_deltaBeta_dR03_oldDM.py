...
outputFilePath = "/nfs/dust/cms/user/anehrkor/TauIDMVATraining2016/Summer16_25ns_V2/%s/trainfilesfinal_dR03_oldDMs_v1/" % version
...
cutDiscriminators = {
    'rawMVAoldDMdR03wLT' : {
        'preselection'        : preselection_oldDMs,
        'discriminator'       : 'byIsolationMVArun2v1DBdR03oldDMwLTraw',
        'numBins'             : 30000,
        'min'                 : -1.5,
        'max'                 : +1.5,
