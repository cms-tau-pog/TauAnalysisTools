...
version = 'tauId_v2_15'
train_option = 'optaPuWeightAll'

inputFilePath  = "/nfs/dust/cms/user/anayak/CMS/Ntuple_Spring15TauID/MVAIsoTraining/%s/" % version

outputFilePath = "/nfs/dust/cms/user/anayak/CMS/Ntuple_Spring15TauID/MVAIsoTraining/%s/trainfilesfinal_v1/" % version
...
preselection_oldDMs = \
  ...
  + ' && leadPFChargedHadrCandPt > 1. && tauIsoDeltaR05PtThresholdsLoose3HitsChargedIsoPtSum < 10.'
preselection_newDMs = \
...
mvaDiscriminators = {
    'mvaIsolation3HitsDeltaR05opt2aPuWeight' : {
        ...
        'inputVariables'      : [
            ...
            'TMath::Log(TMath::Max(1.e-2, tauIsoDeltaR05PtThresholdsLoose3HitsNeutralIsoPtSumWeight))/F',
            'TMath::Log(TMath::Max(1.e-2, tauIsoDeltaR05PtThresholdsLoose3HitsFootprintCorrection))/F',
            'TMath::Log(TMath::Max(1.e-2, tauIsoDeltaR05PtThresholdsLoose3HitsPhotonPtSumOutsideSignalCone))/F',
            'recTauDecayMode/I'
        ],
        'spectatorVariables'  : [            
        ...
        'legendEntry'         : "MVA opt2aPuWeight",
        'color'               : 1
    },
    'mvaIsolation3HitsDeltaR05opt3aPuWeight' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
        'applyEventPruning'   : 1,
        'mvaTrainingOptions'  : "!H:!V:NTrees=1000:BoostType=Grad:Shrinkage=0.30:UseBaggedBoost:GradBaggingFraction=0.5:SeparationType=GiniIndex:nCuts=500:PruneMethod=NoPruning:MaxDepth=4",
        'inputVariables'      : [
            'TMath::Log(TMath::Max(1., recTauPt))/F',
            'TMath::Abs(recTauEta)/F',
            'TMath::Log(TMath::Max(1.e-2, tauIsoDeltaR05PtThresholdsLoose3HitsChargedIsoPtSum))/F',
        ...
        'legendEntry'         : "MVA opt3aPuWeight",
        'color'               : 2
    },
    'mvaIsolation3HitsDeltaR05opt4aLTPuWeight' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
        ...
        'legendEntry'         : "MVA opt4aLTPuWeight",
        'color'               : 4
    },
    'mvaIsolation3HitsDeltaR05opt5aLTPuWeight' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
        ...
        'legendEntry'         : "MVA opt5aLTPuWeight",
        'color'               : 6
    }
}

cutDiscriminators = {
    'hpsPileupWeightedIsolation3HitsLooseOldDMs' : {
        'preselection'        : preselection_oldDMs,
        'discriminator'       : 'byLoosePileupWeightedIsolation3Hits',
        'numBins'             : 2,
        'min'                 : -0.5,
        'max'                 : +1.5,
        'legendEntry'         : "HPS 3hit: #DeltaR = 0.5, PileupWeighted",
        'color'               : 8,
        'markerStyle'         : 20
    },
    'hpsPileupWeightedIsolation3HitsMediumOldDMs' : {
        'preselection'        : preselection_oldDMs,
        'discriminator'       : 'byMediumPileupWeightedIsolation3Hits',
        'numBins'             : 2,
        'min'                 : -0.5,
        'max'                 : +1.5,
        'legendEntry'         : "",
    ...
    'hpsPileupWeightedIsolation3HitsTightOldDMs' : {
        'preselection'        : preselection_oldDMs,
        'discriminator'       : 'byTightPileupWeightedIsolation3Hits',
        'numBins'             : 2,
        'min'                 : -0.5,
        'max'                 : +1.5,
        'legendEntry'         : "",
...
#        'markerSize'          : 2
#    },        
#    'hpsCombinedIsolation3HitsDeltaR05DB045NewDMs' : {
...
#        'min'                 : -5.,
#        'max'                 : +7.,
#        'legendEntry'         : "HPS 3hit: #DeltaR = 0.5, #Delta#beta = 0.45, New DMs",
#        'color'               : 8
#    },
...
##            'mvaIsolation3HitsDeltaR05opt2b',
##            'mvaIsolation3HitsDeltaR05opt2bLT',
##            'mvaIsolation3HitsDeltaR05opt3bLT',
##            'mvaIsolation3HitsDeltaR05opt4bLT',
##            'hpsCombinedIsolation3HitsDeltaR05DB045NewDMs'
##        ]
##    },
#    'mvaIsolation_optDeltaR05' : {
#        'graphs' : [
#            'mvaIsolation3HitsDeltaR05opt2a',
#            'mvaIsolation3HitsDeltaR05opt2aLT',
#            'mvaIsolation3HitsDeltaR05opt3aLT',
#            #'mvaIsolation3HitsDeltaR05opt4aLT',
#            'mvaIsolation3HitsDeltaR05opt2b',
#            'mvaIsolation3HitsDeltaR05opt2bLT',
#            'mvaIsolation3HitsDeltaR05opt3bLT'
#            #'mvaIsolation3HitsDeltaR05opt4bLT'
#        ]
#    },
'mvaIsolation_optDeltaR05APuWeight' : {
        'graphs' : [
            'mvaIsolation3HitsDeltaR05opt2aPuWeight',
            'mvaIsolation3HitsDeltaR05opt3aPuWeight',
            'mvaIsolation3HitsDeltaR05opt4aLTPuWeight',
