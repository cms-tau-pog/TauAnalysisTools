...
mvaDiscriminators = {
    'mvaIsolation3HitsDeltaR05opt2aDB' : {
        ...
        'legendEntry'         : "MVA opt2aDB",
        'color'               : 1
    },    
    'mvaIsolation3HitsDeltaR05opt3aDB' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
        ...
        'legendEntry'         : "MVA opt3aDB",
        'color'               : 2
    },    
    'mvaIsolation3HitsDeltaR05opt4aLTDB' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
        ...
        'legendEntry'         : "MVA opt4aLTDB",
        'color'               : 4
    },
    'mvaIsolation3HitsDeltaR05opt5aLTDB' : {
        'preselection'        : preselection_oldDMs,
        'applyPtReweighting'  : True,
        'applyEtaReweighting' : True,
        'reweight'            : 'min:KILL',
...
#        ]
#    },
'mvaIsolation_optDeltaR05ADeltaBeta' : {
        'graphs' : [
            'mvaIsolation3HitsDeltaR05opt2aDB',
            'mvaIsolation3HitsDeltaR05opt3aDB',
            'mvaIsolation3HitsDeltaR05opt4aLTDB',
