...
process.maxEvents = cms.untracked.PSet(            
    input = cms.untracked.int32(1) # needs to be set to 1 so that GBRForestWriter::analyze method gets called exactly once         
)
...
if updateAntiElectronDiscrMVA:
    process.load('TauAnalysisTools/TauAnalysisTools/writeAntiElectronDiscrMVA_cfi')
...
if updateAntiMuonDiscrMVA:
    process.load('TauAnalysisTools/TauAnalysisTools/writeAntiMuonDiscrMVA_cfi')
